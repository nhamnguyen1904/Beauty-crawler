...
writer.writerow(["Tiêu đề", "Giá", "Mô tả ngắn", "Mô tả chi tiết"]) #viết vào file csv dòng đầu tiên tiêu đề giá ảnh
...
for i in range(1, 10):
    ...
    for link in link_products:
        ...
        # # colors=','.join(colors)
        #
        # images=browser.find_elements(by=By.CSS_SELECTOR, value='.productView-thumbnail-link')#Lấy ảnh
        # image_urls = []
        # for image in images:
